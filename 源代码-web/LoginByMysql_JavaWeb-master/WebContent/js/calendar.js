...
// $Id: calendar_cn.js,v 1.1 2006/05/15 06:28:29 cww Exp $
...
//var l = { x: el.offsetWidth, y: el.offsetHeight };
	//alert(screen.width);
//	if(l.x<160 ){
//		alert(l.x);
//	r.x -= 160 +l.x;	
...
Calendar.prototype.showMonthsCombo = function () {
	var cal = Calendar._C;
	if (!cal) {
		return false;
	}
...
Calendar.dayMouseDblClick = function(ev) {
	...
	if (Calendar.is_ie) {
		document.activeElement.value = '';/*document.selection.empty();陆荣修改，更改双击时提示错误*/
	}
};
...
Calendar.prototype.showAtElement = function (el,moveX) {
	...
	//alert(b.tagName + "--" +b.offsetWidth);
	if(moveX ==null)
	{
		if(b.offsetWidth-p.x<170){
		this.showAt(p.x-170+(b.offsetWidth-p.x), p.y + el.offsetHeight);
		}
		else
		{
...
// tooltips
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "切换周首日";
Calendar._TT["PREV_YEAR"] = "按住菜单,下拉选择年份";
Calendar._TT["PREV_MONTH"] = "按住菜单,下拉选择月份";
Calendar._TT["GO_TODAY"] = "选择本日";
Calendar._TT["NEXT_MONTH"] = "按住菜单,下拉选择月份";
Calendar._TT["NEXT_YEAR"] = "按住菜单,下拉选择年份";
Calendar._TT["SEL_DATE"] = "选择日期";
Calendar._TT["DRAG_TO_MOVE"] = "拖曳";
Calendar._TT["PART_TODAY"] = " (本日)";
Calendar._TT["MON_FIRST"] = "以周一作为第一天";
Calendar._TT["SUN_FIRST"] = "以周日作为第一天";
Calendar._TT["CLOSE"] = "关闭";
Calendar._TT["TODAY"] = "选择本日";
...
function image_start_load() {
	var ul=document.getElementById("tupian_ul");
    var 
}
