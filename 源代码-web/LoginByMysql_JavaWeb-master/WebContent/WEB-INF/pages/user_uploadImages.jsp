	 ...
	 async function isvalid() {
		...
		if (${is_image_info_valid }!="true" ) {
         ...
         for (var i=0;i<nodes.length;++i){
             nodes[i].setAttribute("src",nodes[i].getAttribute("src")+"?1");
         }
         await sleep(1000);	
         var nodes=document.getElementsByTagName("img");
         for (var i=0;i<nodes.length;++i){
         ...
         var nodes=document.getElementsByTagName("img");
         for (var i=0;i<nodes.length;++i){
             nodes[i].setAttribute("src",nodes[i].getAttribute("src")+"2");
         }
         await sleep(1000);	
         var nodes=document.getElementsByTagName("img");
         for (var i=0;i<nodes.length;++i){
             nodes[i].setAttribute("src",nodes[i].getAttribute("src")+"3");
         }	
      }
...
<body onload="isvalid()">
	...
	<div class="header-inner body-width">
		...
		<ul>
			...
			<li><span class="line"></span> <a class="icon-text__pink">上传图片</a></li>
			<li><span class="line"></span> <a class="icon-text__pink register">已登录</a></li>
			<li><span class="line"></span> <a href="${pageContext.request.contextPath }/servlet/LogoutServlet">注销</a></li>
            </c:if>
            <c:if test="${empty sessionScope.user}">
				...
				<div class="main-cont__title">
					<ul class="main-cont__list clearfix">
						...
						<div class="box">
							...
							<form action="${pageContext.request.contextPath }/servlet/UploadSearch_GlobleServlet" method="post" id="form_submit_globle">
				...
				<ul class="main-cont__list clearfix">
					<form class="search_form"
						...
						<table border="1" class="mytable">
							...
							<tr>
								<td width="20%" align="center" class="table_font">上传图片</td>
						...
						<ul class="hList">
							<li><a href="#click" class="menu">
									...
									<ul class="menu-dropdown">
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("country","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("中国","utf-8"),"utf-8")%>'">中国</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("country","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("日本","utf-8"),"utf-8")%>'">日本</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("country","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("美国","utf-8"),"utf-8")%>'">美国</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("country","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("英国","utf-8"),"utf-8")%>'">英国</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("country","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("所有","utf-8"),"utf-8")%>'">所有</li>
									</ul>
							</a></li>
							<li><a href="#click" class="menu">
									<h2 class="menu-title menu-title_2nd">经纬度</h2>
									<ul class="menu-dropdown">
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("latitude_range","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("赤道附近","utf-8"),"utf-8")%>'">赤道附近</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("latitude_range","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("北回归线附近","utf-8"),"utf-8")%>'">北回归线附近</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("latitude_range","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("南回归线附近","utf-8"),"utf-8")%>'">南回归线附近</li>
									    <li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("latitude_range","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("所有","utf-8"),"utf-8")%>'">所有</li>
									</ul>
							</a></li>
							<li><a href="#click" class="menu">
									<h2 class="menu-title menu-title_3rd">图像类型</h2>
									<ul class="menu-dropdown">
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("image_category","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("遥感图像","utf-8"),"utf-8")%>'">遥感图像</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("image_category","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("卫星样图","utf-8"),"utf-8")%>'">卫星样图</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("image_category","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("环境监测","utf-8"),"utf-8")%>'">环境监测</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("image_category","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("所有","utf-8"),"utf-8")%>'">所有</li>
									</ul>
							</a></li>
							<li><a href="#click" class="menu">
									<h2 class="menu-title menu-title_4th">卫星</h2>
									<ul class="menu-dropdown">
									    <li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("satellite","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("SVIA","utf-8"),"utf-8")%>'">SVIA</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("satellite","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("SVIB","utf-8"),"utf-8")%>'">SVIB</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("satellite","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("SVIC","utf-8"),"utf-8")%>'">SVIC</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("satellite","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("SVID","utf-8"),"utf-8")%>'">SVID</li>
										<li onclick="javascript:window.location.href='${pageContext.request.contextPath }/servlet/UploadSearch_MenuServlet?key=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("satellite","utf-8"),"utf-8")%>&value=<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("所有","utf-8"),"utf-8")%>'">所有</li>
									</ul>
							</a></li>
						</ul>
						<script
