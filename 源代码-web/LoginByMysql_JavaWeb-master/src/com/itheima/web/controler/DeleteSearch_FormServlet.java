...
/**
 * Servlet implementation class DeleteSearch_FormServlet
 */
@WebServlet("/DeleteSearch_FormServlet")
public class DeleteSearch_FormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public DeleteSearch_FormServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		images_list=Image.find_by_multiple_with_jurisdiction(image);
		if(images_list!=null) {
