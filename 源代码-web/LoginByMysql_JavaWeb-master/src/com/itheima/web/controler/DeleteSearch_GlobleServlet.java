...
import com.itheima.web.controler.DeleteSearch_GlobleServlet;
...
@WebServlet({"/DeleteSearch_GlobleServlet"})
public class DeleteSearch_GlobleServlet
  extends HttpServlet
{
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if (temp != null && temp.length != 0) {
      images_list = Image.find_by_biaoqian_with_jurisdiction(temp, user.getUsername());
    }
